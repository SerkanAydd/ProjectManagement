    ...
    public static boolean createHighHonorCertificates(List<Studentt> studentList) {
        ...
        for (Studentt student : studentList) {
            ...
            try {
                ...
                String text = "Dear " + student.getName() + ", due to your academic success in the Department of " + student.getDepartment() + ", Faculty of " + student.getFaculty() + ", you have been placed on the High Honor List by the Rectorate of Izmir Institute of Technology. Congratulations, and I wish you continued success.";
